...
;   12/15/2004  Yaswant Pradhan  GlobCOLOUR compatible
;
; $Log: read_netcdf.pro,v $
; Revision 6.2  2006/15/12 13:31:15 yaswant
; GlobCOLOUR compatible, no major changes to  6.1
;
...
;
;
;idver='$Id: read_netcdf.pro,v 6.2 2006/15/12 13:31:15 yaswant Exp $'
;
;+
...
for k=0, finq.nvars-1 do begin
    ...
    endcase
    var_inq[k].ptr = PTR_NEW( theData )    ;-yaswant
endfor
...
for k=0, finq.nvars-1 do begin
    case var_inq[k].nest_level of
       0:  begin
         NCDF_VARGET, fid, k, value       ;-yaswant
